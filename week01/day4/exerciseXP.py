...
try:
    ...
    print("You cannot add an item to a tuple because tuples are immutable.")
...
# Create a list containing the following sequence of mixed types:
# floats and integers: 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5.
...
# (they can input several fruits, separated by spaces).
...
user_fav_fruit = input("Type your favorite fruits, separated by spaces: ")

fruit_list = user_fav_fruit.split()
...
print(f"You've chosen {toppings_list} and your total is ${total:.2f}")
...
while True:
    age_input = input("Enter the age of an attendee (or type 'done' to finish): ")
